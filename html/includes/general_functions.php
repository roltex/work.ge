...
function build_menu_by_id($database_link, $parent_id, $section_language, $menu_id, $level = 0, $menu_class = '') {
...
function banners($language, $type, $order_by = "`sort`"){
	...
	$query = "SELECT * FROM `bc_banner` WHERE `type` = ".$type." AND `language` = '". $language ."' AND `active` = 'Y' ORDER BY ".$order_by."";
