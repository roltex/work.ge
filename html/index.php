...
// Generate Menus
$main_menu = build_menu_by_id($database_link, 0, $siteData['language'], 2, 0, 'nav nav-bar clearfix font-title');
$top_menu = build_menu_by_id($database_link, 0, $siteData['language'], 5, 0);
