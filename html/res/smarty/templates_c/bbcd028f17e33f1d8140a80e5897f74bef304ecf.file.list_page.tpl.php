<?php /* Smarty version Smarty-3.1.13, created on 2016-11-09 08:30:17
...
?>
						<li>
							<a class="accordion-link" href="#"><?php if ($_smarty_tpl->tpl_vars['site_data']->value['section_style']==1){?><i class="fa fa-clock-o"></i> <?php echo $_smarty_tpl->tpl_vars['info_item']->value['start_date'][0];?>
 - <?php echo $_smarty_tpl->tpl_vars['info_item']->value['end_date'][0];?>
 | <?php }?><?php echo $_smarty_tpl->tpl_vars['info_item']->value['title'];?>
</a>
							<ul class="accordion-list-content"><span><?php echo $_smarty_tpl->tpl_vars['info_item']->value['content'];?>
</span>
							</ul>
						</li>
                        <?php } ?>
