<?php /* Smarty version Smarty-3.1.13, created on 2016-09-30 19:15:31
...
" <?php if ($_smarty_tpl->tpl_vars['active_year']->value==$_smarty_tpl->tpl_vars['year']->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['year']->value;?>
				...
				<select class="form-control month" name="month">
					<option><?php echo $_smarty_tpl->tpl_vars['language']->value['month'];?>
</option>
...
" <?php if ($_smarty_tpl->tpl_vars['active_month']->value==$_smarty_tpl->tpl_vars['index']->value){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['month']->value;?>
</option>
					<?php } ?>
				</select>
