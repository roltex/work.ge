...
/*
	...
	$('#type').change(function() {
		...
		$.each(optionsArray,function(index,element){
			$('#style').append('<label class="radio-inline"><input id="style-'+index+'" value="'+index+'" type="radio" class="styled" name="style"/><i class="'+element.className+'"></i>'+element.description+'</label>');
			});
        });
	});
