...
$get_query = "SELECT * FROM	`bc_subscribers` WHERE id = ".$user_id;
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<th class="text-right"><?php echo $TRANSLATION['language']; ?></th>
				<td>
					<input type="text" name="name" class="input-xxlarge" value="<?php echo $user_info->language; ?>" />
				</td>
