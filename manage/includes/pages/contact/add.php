		...
		<tbody>
            ...
            <tr>
				...
				<td>
					...
					<input type="text" placeholder="<?php echo $TRANSLATION['longitude']; ?>" name="lng" id="lng" class="input-small" />
                    <input type="text" placeholder="<?php echo $TRANSLATION['latitude']; ?>" name="lat" id="lat" class="input-small" />
